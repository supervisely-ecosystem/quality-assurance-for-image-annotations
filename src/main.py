...
def main_func(user_id: int, team: TeamInfo, workspace: WorkspaceInfo, project: ProjectInfo):
    ...
    stats = [
        dtools.OverviewPieChart(project_meta, project_stats),
        dtools.OverviewDonutChart(project_meta, project_stats),
    ...
    if g.api.file.dir_exists(team.id, tf_project_dir):
        mandatory_class_stats = (
            dtools.OverviewPieChart, 
            dtools.OverviewDonutChart,
            dtools.ClassBalance,
